      ...
      <section className="container py-16 md:py-24">
        <div className="text-center space-y-6 max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg mx-auto text-left max-w-3xl">
            ...
            <p className="text-muted-foreground leading-relaxed">
              Mei befriended Barry and his very pregnant wife Mary, who were seeking shelter from persecution in the city. Billy was helping Mary's midwife, Mathilda when Bluma was born. Billy was the first thing baby Bluma saw. Like a baby duckling following the first moving thing it sees, Bluma fixated on Billy and as soon as she could crawl, she followed him everywhere, annoying the little boy.
            </p>
            <p className="text-muted-foreground leading-relaxed">
              As the only children in the community, Billy and Bluma bonded, with the older boy taking care of the little girl in dangerous situations. After the Battle of Armageddon, the survivors move to different kingdoms to start afresh in the new Utopian world. Bluma goes with her parents Barry and Mary, while Billy follows his foster parents into Jayden's kingdom.
            </p>
            <p className="text-muted-foreground leading-relaxed">
              Billy is a naughty but extremely adorable boy who is spoiled by his foster parents, Boris and his wife Ava, Mei and her husband Leo. Mei encourages his love for learning new things and even teaches him to fly her plane which is built for her petite frame. So begins The Adventures of Billy Lionheart.
            </p>
          </div>
        </div>
      </section>
