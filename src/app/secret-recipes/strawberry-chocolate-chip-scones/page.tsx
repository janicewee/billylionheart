        ...
        <div className="text-center space-y-4 mb-12">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            ...
            <div className="relative aspect-video w-full max-w-2xl mx-auto rounded-2xl overflow-hidden shadow-2xl mt-8">
              <Image
                src="https://slelguoygbfzlpylpxfs.supabase.co/storage/v1/render/image/public/document-uploads/Screenshot-2025-12-20-at-8.46.28-PM-1766234806076.png?width=800&height=800&resize=contain"
